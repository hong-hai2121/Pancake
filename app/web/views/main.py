...
(function(){
  ...
  // Hai nút trợ lý (Gợi ý trả lời · Trích tri thức) nằm ở app/web/views/troly.py
  // vì màn Hội thoại (/crm/hoi-thoai) dùng chung — sửa một chỗ ăn cả hai màn.
  if (window.__troly) window.__troly(form, ta);
